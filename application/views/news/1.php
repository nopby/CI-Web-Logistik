            ...
            <div class="container">
                <div class="block-content">
                    ...
                    <div class="post-body">
                        ...
                        <div class="post-info"><span>By Sukmanto Apriladi</span><span>Nov 29, 2019</span></div>
                        ...
                        <figure class="figure"><img class="rounded img-fluid figure-img" src="<?= base_url('');?>assets/img/Brand/Dirjen.jpg" alt="A generic square placeholder image with rounded corners in a figure.">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <figure class="figure"><img class="rounded img-fluid figure-img" src="<?= base_url('');?>assets/img/Brand/Ex.jpg" alt="A generic square placeholder image with rounded corners in a figure.">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <figure class="figure"><img class="rounded img-fluid figure-img" src="<?= base_url('');?>assets/img/Brand/Inter.jpg" alt="A generic square placeholder image with rounded corners in a figure.">
