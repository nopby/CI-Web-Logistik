        ...
        <section class="clean-block payment-form dark">
            <div class="container">
                <div class="block-heading">
                    ...
                    <p>Terima kasih Untuk Upgrade Member Anda</p>
                </div>
                <form>
                    <div class="products">
                        <h3 class="title">Checkout</h3>
                        <div class="item"><span class="price">Rp.1.250.000,-</span>
                            <p class="item-name">Platinum Member</p>
                            <p class="item-description">Dapatkan Kesempatan Untuk menjadi Pemenang Lucky Wheels Dan Bonus Lainnya</p>
                        </div>
