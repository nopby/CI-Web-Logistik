                    ...
                    <section class="clean-block clean-post dark">
                        <div class="container mt-4 mb-4">
                            <div class="block-content">
                                <div class="post-image" style="background-image:url(&quot;<?= base_url('')?>assets/img/scenery/image3.jpg&quot;);"></div>
                                <div class="post-body">
                                    <h3>Peserta Platinum Pertama Yang Dapat Mobil !</h3>
                                    <div class="post-info"><span>By Vanessia Fitri</span><span>Jan 16, 2018</span></div>
                                    ...
                                    <figure class="figure"><img class="rounded img-fluid figure-img" src="<?= base_url('')?>assets/img/Brand/Winner.jpg" alt="A generic square placeholder image with rounded corners in a figure.">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <figure class="figure"><img class="rounded img-fluid figure-img" src="<?= base_url('')?>assets/img/Brand/Lucky.jpg" alt="A generic square placeholder image with rounded corners in a figure.">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <figure class="figure"><img class="rounded img-fluid figure-img" src="<?= base_url('')?>assets/img/Brand/Curang.jpg" alt="A generic square placeholder image with rounded corners in a figure.">
