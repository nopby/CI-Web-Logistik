                        ...
                        <div class="container mt-4 mb-4">
                            <div class="block-content">
                                ...
                                <div class="post-body">
                                    ...
                                    <div class="post-info"><span>By Joko Salim</span><span>Sep 11, 2017</span></div>
                                    ...
                                    <figure class="figure"><img class="rounded img-fluid figure-img" src="<?= base_url('')?>assets/img/Brand/kill.png" alt="A generic square placeholder image with rounded corners in a figure.">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <figure class="figure"><img class="rounded img-fluid figure-img" src="<?= base_url('')?>assets/img/Brand/Bukti.jpg" alt="A generic square placeholder image with rounded corners in a figure.">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <figure class="figure"><img class="rounded img-fluid figure-img" src="<?= base_url('')?>assets/img/Brand/Pelaku.jpg" alt="A generic square placeholder image with rounded corners in a figure.">
