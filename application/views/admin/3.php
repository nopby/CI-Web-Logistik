                ...
                <main class="page blog-post">
                    ...
                    <div class="block-content">
                        ...
                        <div class="post-body">
                            ...
                            <div class="post-info"><span>By Samuel Sinagara</span><span>Dec 20, 2017</span></div>
                            ...
                            <figure class="figure"><img class="rounded img-fluid figure-img" src="<?= base_url('')?>assets/img/Profile/B.jpg" alt="A generic square placeholder image with rounded corners in a figure.">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <figure class="figure"><img class="rounded img-fluid figure-img" src="<?= base_url('')?>assets/img/Brand/Gagasan.png" alt="A generic square placeholder image with rounded corners in a figure.">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <figure class="figure"><img class="rounded img-fluid figure-img" src="<?= base_url('')?>assets/img/Brand/Bocor.png" alt="A generic square placeholder image with rounded corners in a figure.">
