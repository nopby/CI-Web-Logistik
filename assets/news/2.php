            ...
            <div class="container">
                <div class="block-content">
                    ...
                    <div class="post-body">
                        ...
                        <figure class="figure"><img class="rounded img-fluid figure-img" src="assets/img/Brand/Winner.jpg" alt="A generic square placeholder image with rounded corners in a figure.">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <figure class="figure"><img class="rounded img-fluid figure-img" src="assets/img/Brand/Lucky.jpg" alt="A generic square placeholder image with rounded corners in a figure.">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <figure class="figure"><img class="rounded img-fluid figure-img" src="assets/img/Brand/Curang.jpg" alt="A generic square placeholder image with rounded corners in a figure.">
